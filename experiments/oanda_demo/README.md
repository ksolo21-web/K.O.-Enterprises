# OANDA demo laboratory — prepared, not connected

Kaleb offered a demo API with $50 virtual funds and a $500 target. This is a separate research experiment, not company revenue. No credentials were received, no market dataset was fetched, no broker orders were sent, and no performance result is claimed.
