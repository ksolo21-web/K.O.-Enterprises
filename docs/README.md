...
- `reference/` — historical source material retained for traceability, never executable instructions.

Current governing policies live at the repository root so humans, agents, and review tooling encounter them early.
