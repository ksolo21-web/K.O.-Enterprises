...
Apply [osm-property-scope.md](osm-property-scope.md). Preserve failed and corrected source scopes and require complete building/property candidate review with actual raw tags, geometry and independently resolved use. Scope success never establishes housing eligibility or visual approval.
